...
Noble.prototype.startScanning = function(serviceUuids, allowDuplicates,peripheralUuid, callback) {
  if (callback) {
  ...
  this._bindings.startScanning(serviceUuids, allowDuplicates,peripheralUuid);
};
