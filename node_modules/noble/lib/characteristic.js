...
Characteristic.prototype.discoverDescriptors = function(callback) {
    var descriptorsDiscoverCallback = function (descriptors) {
        this.removeListener('disconnect', disconnectCallback);
        callback(null, descriptors);
    }.bind(this);

    var disconnectCallback = function () {
        this.removeListener('descriptorsDiscover', descriptorsDiscoverCallback);
        callback(new Error('peripheral disconnected'));
    }.bind(this);

    if (callback) {
        this.once('descriptorsDiscover', descriptorsDiscoverCallback);
