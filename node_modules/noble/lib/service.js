...
Service.prototype.discoverCharacteristics = function (characteristicUuids, callback) {
    var characteristicsDiscoverCallback = function (characteristics) {
        this.removeListener('disconnect', disconnectCallback);
        callback(null, characteristics);
    }.bind(this);

    var disconnectCallback = function () {
        this.removeListener('characteristicsDiscover', characteristicsDiscoverCallback);
        callback(new Error('peripheral disconnected'));
    }.bind(this);

    if (callback) {
        this.once('characteristicsDiscover', characteristicsDiscoverCallback);
